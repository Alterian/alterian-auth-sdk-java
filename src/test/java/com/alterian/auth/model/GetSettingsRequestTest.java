...
/**
 * Model tests for GetSettingsRequest
 */
public class GetSettingsRequestTest {
    private final GetSettingsRequest model = new GetSettingsRequest();
